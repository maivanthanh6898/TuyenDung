<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Editor.aspx.cs" Inherits="TuyenDung.Editor" ValidateRequest="false" %>
...
<body>
    ...
    <!-- End of Header Area -->
    <form class="post-editor ml-100 mr-100" runat="server">
        ...
        <asp:Button ID="btnSave" runat="server" Text="Lưu bài đăng" OnClick="btnSave_Click" />
    </form>
